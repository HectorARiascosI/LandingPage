  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-6 pb-12">
      <div className="flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="flex-1 rounded-2xl overflow-hidden h-[220px]">
          <img
        ...
        {/* RIGHT: Submit a Request with 3 compact orange pill buttons */}
        <div className="flex-1 flex flex-col justify-center">
          <h3 className="text-xl font-bold uppercase text-[#1a1a1a] mb-5">Submit a Request</h3>
          <div className="flex flex-wrap gap-3">
            <a href="#" className="bg-[#F47B20] text-white text-[10px] font-bold tracking-widest px-5 py-3 rounded-full hover:bg-orange-600 transition-colors font-sans text-center">
              CATERING
            </a>
            <a href="#" className="bg-[#F47B20] text-white text-[10px] font-bold tracking-widest px-5 py-3 rounded-full hover:bg-orange-600 transition-colors font-sans text-center">
              PARTY /<br />LARGE
